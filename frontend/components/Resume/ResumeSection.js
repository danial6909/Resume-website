...
export default function ResumeSection() {
  ...
  const resumes = {
    danial: {
      ...
      experience: "2+ سال",
      freelance: "در دسترس",
      bio:"دانشجوی مهندسی کامپیوتر و توسعه‌دهنده فرانت‌اِند با ۲ سال تجربه در اکوسیستم JavaScript. مسلط به React و در حال حاضر متمرکز بر توسعه اپلیکیشن‌های سمت سرور با Next.js. مسیر یادگیری من با هدف تسلط کامل بر MERN Stack و توسعه اپلیکیشن‌های موبایل با Flutter ادامه دارد. علاقه‌مند به نوشتن کدهای استاندارد، کامپوننت‌محور و بهینه.",
      skills: [
